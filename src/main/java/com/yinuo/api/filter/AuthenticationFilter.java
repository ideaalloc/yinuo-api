...
import com.yinuo.api.model.vo.TokenResponse;
...
public class AuthenticationFilter extends GenericFilterBean {
    ...
    private void addSessionContextToLogging() {
        ...
        if (authentication != null && authentication.getDetails() != null && !Strings.isNullOrEmpty(authentication.getDetails().toString())) {
